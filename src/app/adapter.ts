...
export class SignalRAdapter extends ChatAdapter {
  public static serverBaseUrl: string = 'https://ng-chat-api.azurewebsites.net/'; 
  public userId: string;

  private hubConnection: signalR.HubConnection
  // Set this to 'https://localhost:5001/' if running locally

http: HttpClient;
  constructor(private username: string) {
    super();
      this.http.get<User[]>(environment.backend_url + 'user/all').subscribe(post=>{
        console.log('ok');
    });
